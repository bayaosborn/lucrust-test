...
document.getElementById("signin-form").addEventListener("submit", function (event) {
  ...
  (0,firebase_auth__WEBPACK_IMPORTED_MODULE_1__.signInWithEmailAndPassword)(auth, email, password).then(function (user) {
    // Sign in successful
...
document.getElementById("signin-button").classList.add("success");
...
/******/ })()
;
//# sourceMappingURL=signIn8bfdeefec7dfb8b7e4eb.js.map